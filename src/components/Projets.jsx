...
const Projets = ({ Data }) => {
  const [DataUsed, setDataUsed] = useState(Data);

  const bestData = Data.filter(
    (e) => e.id === 3 || e.id === 4 || e.id === 7 || e.id === 8 || e.id === 10 || e.id === 12 || e.id === 13
  );
        ...
        {DataUsed.map((projet) => (
          <div className="project-container" key={projet.id} data-scroll data-scroll-repeat="true">
            ...
            <div className="description-container">
              ...
              <br />
              <p>
                Description technique : <span> {projet.technique}</span>
              </p>
