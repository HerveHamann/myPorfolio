...
import CVHervehamann from "../assets/CVHerveHamann.pdf";
const Contact = () => {
  return (
    <section id="contact" className="contact-page-container" data-scroll-section>
      <div className="contact-container">
        <div className="side-container">
          ...
          <div className="contact-icons" data-scroll data-scroll-repeat="true">
            <a href="https://www.linkedin.com/in/herv%C3%A9-hamann/" rel="noreferrer" target="_blank">
              <svg className="linkedin" width="75px" height="75px" viewBox="0 0 128 128">
                <path
                  fill="#f99f38"
            ...
            <a href="https://github.com/HerveHamann" rel="noreferrer" target="_blank">
              <svg className="github" width="75px" height="75px" viewBox="0 0 128 128">
                <g fill="#f99f38">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
